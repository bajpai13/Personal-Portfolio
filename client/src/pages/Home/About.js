...
function About  ()  {
  ...
  return (
    <div>
      ...
      <div className="flex w-full items-center sm:flex-col">
        <div className="h-[80vh] w-1/2 sm:mt-1 sm:w-3/5 sm:h-[60vh]">
          <img
            src={imageURL}
            alt="About"
            className="h-[65vh] ml-10 mt-8 border-4 border-tertiary sm:h-[50vh] sm:mx-auto"
          />
        </div>
      ...
      <div className="py-10">
        <h1 className="text-tertiary text-xl font-medium sm:text-center">Skills include:</h1>
        <div className="flex flex-wrap gap-16 mt-12 sm:grid sm:grid-cols-3 sm:gap-4">
